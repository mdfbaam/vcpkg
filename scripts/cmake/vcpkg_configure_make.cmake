...
function(z_vcpkg_configure_make_process_flags var_suffix)
    ...
    if(EXISTS "${CURRENT_INSTALLED_DIR}${path_suffix_${var_suffix}}/bin")
        vcpkg_list(PREPEND LDFLAGS "${linker_flag_escape}${library_path_flag}${current_installed_dir_escaped}${path_suffix_${var_suffix}}/bin")
    endif()
...
function(vcpkg_configure_make)
   ...
   # macOS - cross-compiling support
    ...
    if(x_vcpkg_transform_libs)
        ...
        if(VCPKG_TARGET_IS_LLVM_MINGW AND VCPKG_LIBRARY_LINKAGE STREQUAL "dynamic")
            # Like for standard MinGW, various libraries need to be statically linked.
            list(TRANSFORM all_libs_list REPLACE "^-lkernel32\$" "-Wl,-Bstatic,-lkernel32,-Bdynamic")
            list(TRANSFORM all_libs_list REPLACE "^-luser32\$" "-Wl,-Bstatic,-luser32,-Bdynamic")
            list(TRANSFORM all_libs_list REPLACE "^-lgdi32\$" "-Wl,-Bstatic,-lgdi32,-Bdynamic")
            list(TRANSFORM all_libs_list REPLACE "^-lwinspool\$" "-Wl,-Bstatic,-lwinspool,-Bdynamic")
            list(TRANSFORM all_libs_list REPLACE "^-lshell32\$" "-Wl,-Bstatic,-lshell32,-Bdynamic")
            list(TRANSFORM all_libs_list REPLACE "^-lole32\$" "-Wl,-Bstatic,-lole32,-Bdynamic")
            list(TRANSFORM all_libs_list REPLACE "^-loleaut32\$" "-Wl,-Bstatic,-loleaut32,-Bdynamic")
            list(TRANSFORM all_libs_list REPLACE "^-luuid\$" "-Wl,-Bstatic,-luuid,-Bdynamic")
            list(TRANSFORM all_libs_list REPLACE "^-lcomdlg32\$" "-Wl,-Bstatic,-lcomdlg32,-Bdynamic")
            list(TRANSFORM all_libs_list REPLACE "^-ladvapi32\$" "-Wl,-Bstatic,-ladvapi32,-Bdynamic")
        endif()
    endif()
    if(all_libs_list)
    ...
    foreach(current_buildtype IN LISTS all_buildtypes)
        ...
        if (NOT arg_SKIP_CONFIGURE)
            ...
            if(VCPKG_TARGET_IS_WINDOWS AND NOT (VCPKG_TARGET_IS_MINGW OR VCPKG_TARGET_IS_LLVM_MINGW) AND VCPKG_LIBRARY_LINKAGE STREQUAL dynamic)
